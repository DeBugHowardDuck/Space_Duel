...
def get_unit_class(slug: str) -> UnitClass:
    """Возвращает класс корабля по ключу-«слагу» или кидает KeyError с понятным текстом."""
    try:
